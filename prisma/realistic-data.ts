...
export const brands = [
  { name: 'Shan', slug: 'shan', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Shan' },
  { name: 'MDH', slug: 'mdh', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=MDH' },
  { name: 'National', slug: 'national', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=National' },
  { name: 'Pran', slug: 'pran', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Pran' },
  { name: "Haldiram's", slug: 'haldirams', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Haldiram%27s' },
  { name: 'Amul', slug: 'amul', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Amul' },
  { name: 'Tilda', slug: 'tilda', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Tilda' },
  { name: 'Daawat', slug: 'daawat', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Daawat' },
  { name: 'Kohinoor', slug: 'kohinoor', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Kohinoor' },
  { name: 'Maggi', slug: 'maggi', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Maggi' },
  { name: 'Knorr', slug: 'knorr', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Knorr' },
  { name: 'Bombay Sweets', slug: 'bombay-sweets', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Bombay+Sweets' },
  { name: 'Laziza', slug: 'laziza', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Laziza' },
  { name: 'Al Islami', slug: 'al-islami', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Al+Islami' },
  { name: 'Sadia', slug: 'sadia', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Sadia' },
  { name: 'Doux', slug: 'doux', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Doux' },
  { name: 'Seara', slug: 'seara', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Seara' },
  { name: 'Almarai', slug: 'almarai', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Almarai' },
  { name: 'Lipton', slug: 'lipton', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Lipton' },
  { name: 'Brooke Bond', slug: 'brooke-bond', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Brooke+Bond' },
  { name: 'Taj Mahal', slug: 'taj-mahal', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Taj+Mahal' },
  { name: 'Rooh Afza', slug: 'rooh-afza', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Rooh+Afza' },
  { name: 'Hemani', slug: 'hemani', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Hemani' },
  { name: 'Dabur', slug: 'dabur', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Dabur' },
  { name: 'Himalaya', slug: 'himalaya', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Himalaya' },
  { name: 'Parachute', slug: 'parachute', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Parachute' },
  { name: 'Patanjali', slug: 'patanjali', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Patanjali' },
  { name: 'Aashirvaad', slug: 'aashirvaad', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Aashirvaad' },
  { name: 'Ziyad', slug: 'ziyad', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Ziyad' },
  { name: 'Midamar', slug: 'midamar', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Midamar' },
  { name: 'Al Safa', slug: 'al-safa', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Al+Safa' },
  { name: 'Ahmed Foods', slug: 'ahmed-foods', logo: 'https://placehold.co/400x200/EEE/31343C?font=montserrat&text=Ahmed+Foods' },
];
